export module Examples:textured_cube;

import Examples;

import <Application.h>;

export void Example::textured_cube()
{
	Application app;
	...
	app.SetVerticesAndColors(g_vertex_buffer_data, g_color_buffer_data, 108, 0);
	app.AddTextures("resources/textures/Image.bmp");
	app.SetUVs(g_uv_buffer_data, 72);

	app.BindBuffers();
	float rotate = 0.0f;
	do {
		app.SetView(glm::lookAt(
			glm::vec3(4 * cos(rotate), 2, 4 * sin(rotate)), // Camera is at (4,3,-3), in World Space
